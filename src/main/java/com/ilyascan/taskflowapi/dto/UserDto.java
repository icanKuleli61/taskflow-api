...
public class UserDto {
    ...
    @Size(max = 20,message = "Kullanıcı adınız en fazla 10 karakter uzunluğunda olabilir")
    private String username;

    @NotBlank(message = "İsminiz boş olamaz.")
    @Size(max = 20,message = "isminiz en fazla 20 karakter uzunluğunda olmalıdır.")
    private String firstName;

    @NotBlank(message = "Soyadınız boş olamaz.")
    @Size(max = 15,message = "Soyadınız en fazla 15 karakter uzunluğunda olmalıdır.")
